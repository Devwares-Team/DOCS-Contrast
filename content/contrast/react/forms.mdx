---
title: 'Forms'
metaTitle: 'React Bootstrap 5 Forms'
metaDescription: 'These are React Bootstrap 5 forms '
githubUrl: "https://github.com/Devwares-Team/DOCS-Contrast/blob/master/content/contrast/react/forms.mdx"
---
...
<div class="container">
  <div class="border d-flex flex-column" style="width:30rem; border-radius: 15px">
    <div class="mx-4 p-3">
  ...
  <div class="border d-flex flex-column" style="width:30rem; border-radius: 15px">
    <div class="mx-4 p-3">
      ...
      <div class="d-flex mt-4 align-items-center">
        <button
          style="width:30%; background:linear-gradient(0deg, rgba(152,117,196,1) 0%, rgba(169,208,213,0.8746849081429446) 100%);  border-radius: 15px"
          class="btn btn-block"
        >
          Sign up
        </button>
    ...
    <div
      class="pt-4"
      style="background:linear-gradient(0deg, rgba(152,117,196,1) 0%, rgba(169,208,213,0.8746849081429446) 100%); border-radius: 15px"
    >
...
<div class="container">
  <div
    ...
    style="width:30rem; background:url(https://images.unsplash.com/photo-1528287942171-fbe365d1d9ac?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&w=1200&cs=srgb&ixid=eyJh); background-size:cover;  border-radius: 15px"
  >
