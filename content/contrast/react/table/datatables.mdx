...
metaDescription: 'Building a DataTable Component using React Bootstrap can be as easy as building any technology. The DataTable comes with some preety cool functions that help in sorting, searching and pagination of data.'
---
...
![React Bootstrap Default DateTable](https://i.imgur.com/gIkW791.gif)
...
![React Bootstrap Not Striped DateTable](https://i.imgur.com/YE5dgYk.gif)
...
![React Bootstrap Fixed Height DataTables](https://i.imgur.com/YFD0gPm.gif)
...
![React Bootstrap Disabled Button](https://i.imgur.com/r9A66GD.gif)
...
![React Bootstrap Full Pagination DataTables](https://i.imgur.com/2knDIqn.gif)
...
![React Bootstrap Checkbox](https://i.imgur.com/gNWiaIb.gif)
...
![React Bootstrap No Sort DataTable](https://i.imgur.com/og0Z2Ck.gif)
...
![React Bootstrap No Info](https://i.imgur.com/Aqqein8.gif)
...
![React Bootstrap DataTable No Pagination](https://i.imgur.com/WxNQdjY.gif)
...
## API Reference: Contrast React Bootstrap DataTable Props

This section will build on your information about the props you get to use with the Contrast React Bootstrap DataTable component. You will find out what these props do, their default values, and how you would use them in your code.
