...
metaDescription: "Building a TimePicker Component using React Bootstrap 5"
githubUrl: "https://github.com/Devwares-Team/DOCS-Contrast/blob/master/content/contrast/react/sections/timepicker.mdx"
---
...
React Bootstrap 5 time picker is a component which uses a dialog to select a single time in `hours:minutes` format. The selected time is indicated by the filled circle at the end of the clock hand.

## Importing the React Bootstrap 5 TimePicker Component

To use the Contrast React Bootstrap 5 TimePicker component, you import `CDBTimePicker` into your project.
...
<img src={timepickerImg} width="300px" alt="Contrast React Bootstrap 5 TimePicker"/>
