---
title: 'Pagination'
metaTitle: 'Pagination Component for React Bootstrap 5'
metaDescription: 'Building a Pagination Component using React Bootstrap 5'
githubUrl: "https://github.com/Devwares-Team/DOCS-Contrast/blob/master/content/contrast/react/navigation/pagination.mdx"
...
To use the Contrast React Bootstrap 5 Pagination component, you import `CDBPagination` into your project.
...
<div class="container">
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      <li class="page-item">
        <span class="page-link page-link-round" href="#">
          Prev
        </span>
      </li>
      <li class="page-item">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      <li class="page-item">
        <span class="page-link page-link-round text-white bg-success" href="#">
          Prev
        </span>
      </li>
      <li class="page-item">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination pagination-secondary">
      <li class="page-item">
        <span class="page-link text-white bg-secondary" href="#">
          Prev
        </span>
      </li>
      <li class="page-item">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination pagination-sm">
      <li class="page-item">
        <span class="page-link text-dark bg-warning" href="#">
          Prev
        </span>
      </li>
      <li class="page-item">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination pagination-sm">
      <li class="page-item">
        <span class="page-link text-dark bg-white" href="#">
          Prev
        </span>
      </li>
      <li class="page-item">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      <li class="page-item">
        <span class="page-link text-dark bg-light" href="#">
          Prev
        </span>
      </li>
      <li class="page-item">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      <li class="page-item">
        <span class="page-link text-white bg-danger" href="#">
          Prev
        </span>
      </li>
      <li class="page-item">
