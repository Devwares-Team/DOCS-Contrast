...
metaDescription: "React Bootstrap 5 Badges can be used to display notifications such as unread messages and missed phone calls."
githubUrl: "https://github.com/Devwares-Team/DOCS-Contrast/blob/master/content/contrast/react/components/badge.mdx"
---
...
The [CDBIcon](https://www.devwares.com/docs/contrast/react/components/icon) component is used in this tutorial. More information on how to use the Contrast React Bootstrap 5 Icon in your project can be found in our documentation.
