...
metaDescription: 'React Bootstrap 5 Icons are little images or symbols that can serve as a link, transmit information, or are merely aesthetic'
githubUrl: "https://github.com/Devwares-Team/DOCS-Contrast/blob/master/content/contrast/react/components/icon.mdx"
---
...
<div
  class="element"
  style="border: 2px solid #f4f4f4; margin: 0 20px; display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center;
    padding: 20px; align-items: center "
>
  <button type="button" class="btn btn-primary" style="background: #3b82f6">
    <i class="fab fa-stack-overflow"></i>
    <span> click me </span>
  </button>
  <button type="button" class="btn btn-secondary" style="background: #6366f1">
    <i class="fab fa-facebook"></i>
    <span>click me </span>
  </button>
  <button type="button" class="btn btn-success" style="background: #22c55e">
    <i class="fab fa-reddit"></i>
    <span> click me </span>
  </button>
  <button type="button" class="btn btn-danger" style="background: #ef4444">
    <i class="fab fa-twitter"></i>
    <span> click me </span>
  </button>
  <button type="button" class="btn btn-dark" style="background: #111827">
    <i class="fab fa-instagram"></i>
    <span> click me </span>
  </button>
  <button type="button" class="btn btn-warning" style="background: #eab308">
