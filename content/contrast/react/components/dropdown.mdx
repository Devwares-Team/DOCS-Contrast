---
title: "DropDown"
metaTitle: "DropDown Component for React Bootstrap"
metaDescription: "The React Bootstrap Dropdown is a toggleable menu that provides multiple links or content. It enables the creation of complex navigation and link categorization"
---
...
The React Bootstrap Dropdown is a toggleable menu that provides multiple links or content. It enables the creation of complex navigation and link categorization.
...
By adjusting props and prop values, we can give our dropdown component several predefined styles with the React Bootstrap DropDown component. In the examples below, we explored with the 'color' prop (which changes the dropdown's background color), the `dropup` prop (which changes the caret symbol to face upwards), the `dropleft` prop (which changes the caret symbol to face left), the `dropright` prop (which changes the caret symbol to face right), and the `size` prop ( this prop can have values ranging from small to large ).

## Importing the React Bootstrap DropDown Component


To begin using the Contrast React Bootstrap DropDown component, import `CDBDropDown` into your project.
```javascript
...
<div class="container">
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <li><span class="dropdown-item">This is the toggle menu</span></li>
    </ul>
  </div>
</div>
...
<div class="container">
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <li><span class="dropdown-item">This is the toggle menu with caret</span></li>
    </ul>
  </div>
</div>
...
<div class="container">
  <div class="dropdown dropup">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <li><span class="dropdown-item">This is the toggle menu to the top</span></li>
    </ul>
  </div>
</div>
...
<div class="container">
  <div class="dropdown dropleft">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <li><span class="dropdown-item">This is the toggle menu to the left</span></li>
    </ul>
  </div>
</div>
...
<div class="container">
  <div class="dropdown dropright">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      ...
      <li><span class="dropdown-item">second</span></li>
      <li><span class="dropdown-item">second</span></li>
      <li><span class="dropdown-item"><a href="/docs/contrast/react/components/alert">Alert</a></span></li>
    </ul>
  </div>
</div>
...
```javascript
import React from "react";
import { CDBDropDown, CDBDropDownItem, CDBDropDownMenu, CDBDropDownToggle, CDBContainer } from "cdbreact";
...
```javascript
import React from "react";
import { CDBDropDown, CDBDropDownMenu, CDBDropDownItem, CDBDropDownToggle, CDBContainer } from "cdbreact";
...
# Contrast React Bootstrap DropDown Props

This tutorial will expand on your previous knowledge of the props available with the React Bootstrap DropDown component. You'll learn what these properties do, what their default values are, and how to use them in your code.
...
## API Reference: Contrast React Bootstrap DropDownItem Properties
