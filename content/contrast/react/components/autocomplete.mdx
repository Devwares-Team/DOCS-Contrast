...
metaDescription: 'React Bootstrap 5 Autocomplete is a component that predicts words based on the first few letters typed by the user'
githubUrl: "https://github.com/Devwares-Team/DOCS-Contrast/blob/master/content/contrast/react/components/autocomplete.mdx"
---
...
React Bootstrap 5 Autocomplete or autosuggest is a feature owned by a component that that predicts the words based on the first few letters given by a user while typing it. It takes in an `Array` full of suggestions.
