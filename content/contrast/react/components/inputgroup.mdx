---
title: "InputGroup"
metaTitle: "InputGroup Component for React Bootstrap"
metaDescription: "React Bootstrap Input group is used to collect data supplied by the user. It usually consists of buttons, text fields, and other forms of input"
...
React Bootstrap Input group is used to collect data supplied by the user. It usually consists of buttons, text fields, and other forms of input.. Your forms will be more engaging and customizable using this component.

## Importing the React Bootstrap InputGroup Component

You can Start by importing `CDBInputGroup` into your project to use the Contrast React Bootstrap InputGroup component.
...
<div class="container">
  <div class="input-group input-group-lg mb-3">
    <input type="text" class="form-control" placeholder="Basic Input" aria-label="Username" aria-describedby="basic-addon1"/>
  </div>
</div>
...
# Contrast React Bootstrap InputGroup Props

This section will go over the props that the React Bootstrap InputGroup component has to offer. You'll find out what these props are used for, how to use them, and what their default values are.
